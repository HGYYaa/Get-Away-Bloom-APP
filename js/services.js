...
* Description : Generate the request to the web service
...
//Define Constant Key
// const OPENCAGE_KEY = "0b309187aa6a4a7daac31bd503641e63";
// const MAPBOX_TOKEN = "pk.eyJ1IjoidGluZ3lvdSIsImEiOiJja3JidjR5bm40d3E0MnZxaDM2dmozdWZkIn0.4Q0bMxIFVWO6Cez9HfuMuA";
...
function sendXMLRequestForPlaces(query, lng, lat, successCallback) {
    let url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(query) + '.json?limit=10&proximity=' + lng + ',' + lat + '&access_token=' + MAPBOX_TOKEN;
